...
{
	int currbuffer_idx = (GetGlobalResource().getCurrentFrameBufferIndex() + 1) % 2;
    ...
    context.TransitionResource(g_ReservoirRayDirectionHistoryPingPong[currbuffer_idx], D3D12_RESOURCE_STATE_UNORDERED_ACCESS);
	context.TransitionResource(g_ReservoirRayRadianceHistoryPingPong[currbuffer_idx], D3D12_RESOURCE_STATE_UNORDERED_ACCESS);
	context.TransitionResource(g_ReservoirRayDistanceHistoryPingPong[currbuffer_idx], D3D12_RESOURCE_STATE_UNORDERED_ACCESS);
	context.TransitionResource(g_ReservoirRayNormalHistoryPingPong[currbuffer_idx] , D3D12_RESOURCE_STATE_UNORDERED_ACCESS);
	context.TransitionResource(g_ReservoirRayWeightsHistoryPingPong[currbuffer_idx], D3D12_RESOURCE_STATE_UNORDERED_ACCESS);
	context.TransitionResource(g_DownSampledWorldPositionHistoryPingPong[currbuffer_idx], D3D12_RESOURCE_STATE_UNORDERED_ACCESS);
	context.TransitionResource(g_DownSampledWorldNormalHistoryPingPong[currbuffer_idx], D3D12_RESOURCE_STATE_UNORDERED_ACCESS);

    context.FlushResourceBarriers();

	context.ClearUAV(g_ReservoirRayDirectionHistoryPingPong[currbuffer_idx]);
	context.ClearUAV(g_ReservoirRayRadianceHistoryPingPong[currbuffer_idx]);
	context.ClearUAV(g_ReservoirRayDistanceHistoryPingPong[currbuffer_idx]);
	context.ClearUAV(g_ReservoirRayNormalHistoryPingPong[currbuffer_idx]);
	context.ClearUAV(g_ReservoirRayWeightsHistoryPingPong[currbuffer_idx]);
	context.ClearUAV(g_DownSampledWorldPositionHistoryPingPong[currbuffer_idx]);
	context.ClearUAV(g_DownSampledWorldNormalHistoryPingPong[currbuffer_idx]);
	...
	pCommandList->SetComputeRootDescriptorTable(2, outputReservoirs[currbuffer_idx]);
    ...
    D3D12_DISPATCH_RAYS_DESC rayDispatchDesc = CreateRayTracingDesc(g_ReservoirRayDirectionHistoryPingPong[0].GetWidth(), g_ReservoirRayDirectionHistoryPingPong[0].GetHeight());
