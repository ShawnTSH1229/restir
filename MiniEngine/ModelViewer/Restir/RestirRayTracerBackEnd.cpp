    ...
    {
        {
            ...
            Graphics::g_Device->CopyDescriptorsSimple(1, srvHandle, g_ReservoirRayDirectionHistoryPingPong[index].GetUAV(), D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV);
            outputReservoirs[index] = pRaytracingDescriptorHeap->GetGpuHandle(outputReservoirIndex);
        }

        {
            pRaytracingDescriptorHeap->AllocateDescriptor(srvHandle, unusedIndex);
            Graphics::g_Device->CopyDescriptorsSimple(1, srvHandle, g_ReservoirRayRadianceHistoryPingPong[index].GetUAV(), D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV);
        }

        {
            pRaytracingDescriptorHeap->AllocateDescriptor(srvHandle, unusedIndex);
            Graphics::g_Device->CopyDescriptorsSimple(1, srvHandle, g_ReservoirRayDistanceHistoryPingPong[index].GetUAV(), D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV);
        }

        {
            pRaytracingDescriptorHeap->AllocateDescriptor(srvHandle, unusedIndex);
            Graphics::g_Device->CopyDescriptorsSimple(1, srvHandle, g_ReservoirRayNormalHistoryPingPong[index].GetUAV(), D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV);
        }

        {
            pRaytracingDescriptorHeap->AllocateDescriptor(srvHandle, unusedIndex);
            Graphics::g_Device->CopyDescriptorsSimple(1, srvHandle, g_ReservoirRayWeightsHistoryPingPong[index].GetUAV(), D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV);
        }

        {
            pRaytracingDescriptorHeap->AllocateDescriptor(srvHandle, unusedIndex);
            Graphics::g_Device->CopyDescriptorsSimple(1, srvHandle, g_DownSampledWorldPositionHistoryPingPong[index].GetUAV(), D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV);
        }

        {
            pRaytracingDescriptorHeap->AllocateDescriptor(srvHandle, unusedIndex);
            Graphics::g_Device->CopyDescriptorsSimple(1, srvHandle, g_DownSampledWorldNormalHistoryPingPong[index].GetUAV(), D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV);
        }
