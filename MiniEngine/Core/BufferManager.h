...
namespace Graphics
{
    ...
    extern ColorBuffer g_ReservoirRayRadianceHistoryPingPong[2];  // R16G16B16_FLOAT Half Res
    extern ColorBuffer g_ReservoirRayDistanceHistoryPingPong[2];  // R16_FLOAT Half Res
    extern ColorBuffer g_ReservoirRayNormalHistoryPingPong[2];    // R16G16B16_FLOAT Half Res
    extern ColorBuffer g_ReservoirRayWeightsHistoryPingPong[2];    // R16G16B16_FLOAT Half Res
    extern ColorBuffer g_DownSampledWorldPositionHistoryPingPong[2];    // R16G16B16_FLOAT Half Res
    extern ColorBuffer g_DownSampledWorldNormalHistoryPingPong[2];    // R16G16B16_FLOAT Half Res

    extern ColorBuffer g_ReservoirRayDirectionSpatialPingPong[2]; // R16G16B16A16_FLOAT Half Res
    extern ColorBuffer g_ReservoirRayRadianceSpatialPingPong[2];  // R16G16B16_FLOAT Half Res
    extern ColorBuffer g_ReservoirRayDistanceSpatialPingPong[2];  // R16_FLOAT Half Res
    extern ColorBuffer g_ReservoirRayNormalSpatialPingPong[2];    // R16G16B16_FLOAT Half Res
    extern ColorBuffer g_ReservoirRayWeightsSpatialPingPong[2];    // R16G16B16_FLOAT Half ResColorBuffer g_SSAOFullScreen(Color(1.0f, 1.0f, 1.0f));
