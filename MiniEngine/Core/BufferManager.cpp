...
namespace Graphics
{
    ...
    ColorBuffer g_ReservoirRayDistanceHistoryPingPong[2];  // R16_FLOAT Half Res
    ColorBuffer g_ReservoirRayNormalHistoryPingPong[2];    // R16G16B16_FLOAT Half Res
    ColorBuffer g_ReservoirRayWeightsHistoryPingPong[2];    // R16G16B16_FLOAT Half ResColorBuffer g_SSAOFullScreen(Color(1.0f, 1.0f, 1.0f));
    ColorBuffer g_DownSampledWorldPositionHistoryPingPong[2];    // R16G16B16_FLOAT Half ResColorBuffer g_LinearDepth[2];
    ColorBuffer g_DownSampledWorldNormalHistoryPingPong[2];   // R16G16B16_FLOAT Half ResColorBuffer g_MinMaxDepth8;

    ColorBuffer g_ReservoirRayDirectionSpatialPingPong[2]; // R16G16B16A16_FLOAT Half Res
    ColorBuffer g_ReservoirRayRadianceSpatialPingPong[2];  // R16G16B16_FLOAT Half Res
    ColorBuffer g_ReservoirRayDistanceSpatialPingPong[2];  // R16_FLOAT Half Res
    ColorBuffer g_ReservoirRayNormalSpatialPingPong[2];    // R16G16B16_FLOAT Half Res
    ColorBuffer g_ReservoirRayWeightsSpatialPingPong[2];    // R16G16B16_FLOAT Half ResColorBuffer g_SSAOFullScreen(Color(1.0f, 1.0f, 1.0f));
...
void Graphics::InitializeRenderingBuffers( uint32_t bufferWidth, uint32_t bufferHeight )
{
    ...
    esram.PushStack();
        ...
        {
            g_ReservoirRayDirectionHistoryPingPong[index].Create(L"g_ReservoirRayDirectionHistoryPingPong", bufferWidth / 2, bufferHeight / 2, 1, DXGI_FORMAT_R16G16B16A16_FLOAT, esram);
            g_ReservoirRayRadianceHistoryPingPong[index].Create(L"g_ReservoirRayRadianceHistoryPingPong", bufferWidth / 2, bufferHeight / 2, 1, DXGI_FORMAT_R16G16B16A16_FLOAT, esram);
            g_ReservoirRayDistanceHistoryPingPong[index].Create(L"g_ReservoirRayDistanceHistoryPingPong", bufferWidth / 2, bufferHeight / 2, 1, DXGI_FORMAT_R16_FLOAT, esram);
            g_ReservoirRayNormalHistoryPingPong[index].Create(L"g_ReservoirRayNormalHistoryPingPong", bufferWidth / 2, bufferHeight / 2, 1, DXGI_FORMAT_R16G16B16A16_FLOAT, esram);
            g_ReservoirRayWeightsHistoryPingPong[index].Create(L"g_ReservoirRayWeightsHistoryPingPong", bufferWidth / 2, bufferHeight / 2, 1, DXGI_FORMAT_R16G16B16A16_FLOAT, esram);
            g_DownSampledWorldPositionHistoryPingPong[index].Create(L"g_DownSampledWorldPositionHistoryPingPong", bufferWidth / 2, bufferHeight / 2, 1, DXGI_FORMAT_R16G16B16A16_FLOAT, esram);
            g_DownSampledWorldNormalHistoryPingPong[index].Create(L"g_DownSampledWorldNormalHistoryPingPong", bufferWidth / 2, bufferHeight / 2, 1, DXGI_FORMAT_R16G16B16A16_FLOAT, esram);
        }

        for (int index = 0; index < 2; index++)
        {
            g_ReservoirRayDirectionSpatialPingPong[index].Create(L"g_ReservoirRayDirectionSpatialPingPong", bufferWidth / 2, bufferHeight / 2, 1, DXGI_FORMAT_R16G16B16A16_FLOAT, esram);
            g_ReservoirRayRadianceSpatialPingPong[index].Create(L"g_ReservoirRayRadianceSpatialPingPong", bufferWidth / 2, bufferHeight / 2, 1, DXGI_FORMAT_R16G16B16A16_FLOAT, esram);
            g_ReservoirRayDistanceSpatialPingPong[index].Create(L"g_ReservoirRayDistanceSpatialPingPong", bufferWidth / 2, bufferHeight / 2, 1, DXGI_FORMAT_R16_FLOAT, esram);
            g_ReservoirRayNormalSpatialPingPong[index].Create(L"g_ReservoirRayNormalSpatialPingPong", bufferWidth / 2, bufferHeight / 2, 1, DXGI_FORMAT_R16G16B16A16_FLOAT, esram);
            g_ReservoirRayWeightsSpatialPingPong[index].Create(L"g_ReservoirRayWeightsSpatialPingPong", bufferWidth / 2, bufferHeight / 2, 1, DXGI_FORMAT_R16G16B16A16_FLOAT, esram);
        }
...
void Graphics::DestroyRenderingBuffers()
{
    ...
    for (int Index = 0; Index < 2; Index++)
    {
        g_ReservoirRayDirectionHistoryPingPong[Index].Destroy();
        g_ReservoirRayRadianceHistoryPingPong[Index].Destroy();
        g_ReservoirRayDistanceHistoryPingPong[Index].Destroy();
        g_ReservoirRayNormalHistoryPingPong[Index].Destroy();
        g_ReservoirRayWeightsHistoryPingPong[Index].Destroy();
        g_DownSampledWorldPositionHistoryPingPong[Index].Destroy();
        g_DownSampledWorldNormalHistoryPingPong[Index].Destroy();
    }
